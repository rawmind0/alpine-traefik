...
"
		# generate the ACME crendetials env file we need to source prior starting the service
		${SERVICE_HOME}/bin/traefik-export_acme_credentials.sh ${TRAEFIK_ACME_CHALLENGE_DNS_CREDENTIALS} ${SERVICE_HOME}/etc/acme_credentials
    fi
fi
