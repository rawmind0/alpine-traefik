...
| `TRAEFIK_ACME_WILDCARD_DOMAINS=""`                                       | ACME wildcard domain parameter. Use a comma to seprate domains. Note: It needs traefik supports, if treafik was not tested yet, may work unreliably or in errors.                                                             |
